(function () {
  ...
  function buildIntro() {
    ...
    const attendance =
      "Attendance and active participation are essential to this course, as each session builds on the technical and conceptual work of previous weeks. Each week combines discussions of games, artworks, and critical texts with technical tutorials and lab time to work on class assignments. These assignments will gradually build a toolkit for your final project. Students will take turns giving short presentations on assigned readings.<br><br>AI-assisted coding tools are welcome as they can dramatically speed up writing and debugging code. Understanding the basics of code and how Unity works allows you to know what code can do, where it goes, how different systems connect, and how to troubleshoot problems.<br><br>In Week 12, you'll present your final project idea and begin building it. Week 13 is dedicated to playtesting, feedback, and debugging. In Week 14, we'll have final presentations and play everyone's games together.<br><br><strong>Optional:</strong> You're invited to share your work in the collective Integrated Media show on the last gallery night of the semester.";
    container.innerHTML =
      (heading
